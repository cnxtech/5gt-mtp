...
class CompRouteInputNetwLinkQoS(object):
    ...
    def __init__(self, link_cost=None, link_cost_value=None, link_delay=None, link_delay_value=None, link_avail_bw=None, link_avail_bw_value=None):  # noqa: E501
        """CompRouteInputNetwLinkQoS - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def link_cost(self):
        """Gets the link_cost of this CompRouteInputNetwLinkQoS.  # noqa: E501

        Link cost name.  # noqa: E501

        :return: The link_cost of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :rtype: str
        """
    ...
    def link_cost(self, link_cost):
        """Sets the link_cost of this CompRouteInputNetwLinkQoS.

        Link cost name.  # noqa: E501

        :param link_cost: The link_cost of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :type: str
        """
    ...
    def link_cost_value(self):
        """Gets the link_cost_value of this CompRouteInputNetwLinkQoS.  # noqa: E501

        Value of Link Cost  # noqa: E501

        :return: The link_cost_value of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :rtype: float
        """
    ...
    def link_cost_value(self, link_cost_value):
        """Sets the link_cost_value of this CompRouteInputNetwLinkQoS.

        Value of Link Cost  # noqa: E501

        :param link_cost_value: The link_cost_value of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :type: float
        """
    ...
    @property
    def link_delay(self):
        """Gets the link_delay of this CompRouteInputNetwLinkQoS.  # noqa: E501

        Link delay name.  # noqa: E501

        :return: The link_delay of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :rtype: str
        """
    ...
    def link_delay(self, link_delay):
        """Sets the link_delay of this CompRouteInputNetwLinkQoS.

        Link delay name.  # noqa: E501

        :param link_delay: The link_delay of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :type: str
        """
    ...
    def link_delay_value(self):
        """Gets the link_delay_value of this CompRouteInputNetwLinkQoS.  # noqa: E501

        Value of Link Delay (expressed in ms)  # noqa: E501

        :return: The link_delay_value of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :rtype: float
        """
    ...
    def link_delay_value(self, link_delay_value):
        """Sets the link_delay_value of this CompRouteInputNetwLinkQoS.

        Value of Link Delay (expressed in ms)  # noqa: E501

        :param link_delay_value: The link_delay_value of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :type: float
        """
    ...
    def link_avail_bw(self):
        """Gets the link_avail_bw of this CompRouteInputNetwLinkQoS.  # noqa: E501

        Link available bandwidth name.  # noqa: E501

        :return: The link_avail_bw of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :rtype: str
        """
    ...
    def link_avail_bw(self, link_avail_bw):
        """Sets the link_avail_bw of this CompRouteInputNetwLinkQoS.

        Link available bandwidth name.  # noqa: E501

        :param link_avail_bw: The link_avail_bw of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :type: str
        """
    ...
    def link_avail_bw_value(self):
        """Gets the link_avail_bw_value of this CompRouteInputNetwLinkQoS.  # noqa: E501

        Value of available bandwidth in the link (expressed in Mbps)  # noqa: E501

        :return: The link_avail_bw_value of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :rtype: float
        """
    ...
    def link_avail_bw_value(self, link_avail_bw_value):
        """Sets the link_avail_bw_value of this CompRouteInputNetwLinkQoS.

        Value of available bandwidth in the link (expressed in Mbps)  # noqa: E501

        :param link_avail_bw_value: The link_avail_bw_value of this CompRouteInputNetwLinkQoS.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CompRouteInputNetwLinkQoS, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CompRouteInputNetwLinkQoS):
            return False
