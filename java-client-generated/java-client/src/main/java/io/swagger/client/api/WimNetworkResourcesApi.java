...
public class WimNetworkResourcesApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public InlineResponse200 collectWimAbstractedInformation() throws ApiException {
        ApiResponse<InlineResponse200> resp = collectWimAbstractedInformationWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<InlineResponse200> collectWimAbstractedInformationWithHttpInfo() throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call collectWimAbstractedInformationAsync(final ApiCallback<InlineResponse200> callback) throws ApiException {
